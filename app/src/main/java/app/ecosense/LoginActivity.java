...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(!PreferenceManager.getDefaultSharedPreferences(this.getApplicationContext()).getString("TOKEN", "token not found")
                .equals("token not found")) {
    ...
    public class UserLoginTask extends AsyncTask<Void, Void, Boolean> {
        ...
        UserLoginTask(String email, String password, Activity parent) {
            mEmail = email;
            mPassword = password;
            this.parent = parent;
        }
        ...
        protected Boolean doInBackground(Void... params) {
            ...
            try {
                url = new URL(Api.URL_PATH + "oauth/token");
                ...
                if(urlConnection.getResponseCode() == 200) {
                    startActivity(new Intent(this.parent, MainActivity.class));
                }
